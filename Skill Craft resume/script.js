...
resumeButton.addEventListener('click', ()=>{
  ...
  // Function to limit the input length for the number field
  function limitNumberInputLength() {
    var input = document.getElementById('contactField');
    var maxLength = 10; // Maximum length allowed
  ...
  // Call the function to limit the input length for the number field
  limitNumberInputLength();
